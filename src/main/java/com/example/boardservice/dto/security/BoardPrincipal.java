...
public record BoardPrincipal(
    ...
    public static BoardPrincipal of(String username, String password, String email, String nickname, String memo, Map<String, Object> oAuth2Attributes) {
        ...
        return new BoardPrincipal(
                username,
                password,
                // convert set of roleTypes to collection of generics that implements GrantedAuth
                roleTypes.stream()
    ...
    // features provided by Spring that are not used in this project
    // use true stubs
    ...
    public enum RoleType {
        // "ROLE_*" prefix format is default spring security behavior
        // this can be changed in options though
        USER("ROLE_USER");
