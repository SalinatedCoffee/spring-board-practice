...
@DisplayName("DTO - Test Kakao OAuth 2.0 authentication response data")
class KakaoOAuth2ResponseTest {

  private final ObjectMapper mapper = new ObjectMapper();

  @DisplayName("Given auth results as a Map(deserialized json), convert it into a kakao auth response object")
  @Test
